...
<head>
	...
	<script src = "admin_tab_press.js"></script>
	<script src = "admin_display_and_export.js"></script>
...
<body>
	...
	?>
			...
			<ul id ="admin_tabs" class="nav nav-pills"> 
				...
				<li><a data-toggle="pill" href="#m1">Απεικόνιση στοιχείων σε χάρτη και εξαγωγή</a></li>
				<li><a data-toggle="pill" href="#m2">Διαγραφή δεδομένων</a></li>
			...
			<div class="tab-content">
				...
				<div id="m1" class="tab-pane fade">
					<?php include_once("admin_display_and_export.php"); ?>
				</div>
				<div id="m2" class="tab-pane fade" style = "padding: 80px">
					<?php include_once("admin_delete.php"); ?>
				</div>
